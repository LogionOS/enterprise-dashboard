      ...
      <div className="bg-[#0d1117] border border-[#1e293b] rounded-xl p-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
          {[
            ...
            { name: "Japan APPI", color: "text-rose-400 bg-rose-500/10" },
            { name: "UK FCA & ICO", color: "text-sky-400 bg-sky-500/10" },
            { name: "Singapore MAS", color: "text-lime-400 bg-lime-500/10" },
            { name: "HK PDPO & SFC", color: "text-fuchsia-400 bg-fuchsia-500/10" },
            { name: "Canada PIPEDA", color: "text-emerald-400 bg-emerald-500/10" },
            { name: "Korea PIPA", color: "text-blue-400 bg-blue-500/10" },
            { name: "Australia Privacy", color: "text-amber-400 bg-amber-500/10" },
            ...
            { name: "Cross-Border (All)", color: "text-gray-400 bg-gray-500/10" },
          ].map((pack) => (
