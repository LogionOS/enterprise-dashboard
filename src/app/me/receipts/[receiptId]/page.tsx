...
// Basic-tier detail view. The server component, the export proxy, and the
// shared detail components are reused from /teams/[id]/receipts/[id]; the
// only difference is the breadcrumb trail. PDF export is still gated by the
// plan entitlement check; basic users see the disabled button explaining
// they need the Team plan.

export default async function MeReceiptDetailPage({
  params,
}: {
    ...
    return (
      <DashboardShell
        ...
        breadcrumbs={[
          ...
          { label: "Receipts", href: "/me/receipts" },
          { label: receiptId },
        ]}
      >
        <EmptyState
